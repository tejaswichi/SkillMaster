 ...
 * @author shital
 * 
 * This class is created to have the  configuration for generation the primary key sequence for UserSkillMap table
 *
 */
...
public class UserSkillIdGenrator extends SequenceStyleGenerator {
	...
	public static final String NUMBER_FORMAT_DEFAULT = "%1d";
